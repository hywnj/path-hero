...
import com.example.map.jwt.JWTFilter;
import com.example.map.jwt.JWTUtil;
import com.example.map.oauth2.CustomLogoutSuccessHandler;
import com.example.map.oauth2.CustomSuccessHandler;
import com.example.map.service.CustomOAuth2UserService;
import com.example.oauthjwt.jwt.JWTFilter;
import com.example.oauthjwt.jwt.JWTUtil;
import com.example.oauthjwt.oauth2.CustomLogoutSuccessHandler;
...
//                .logoutUrl("/logout")
//                .logoutSuccessUrl("http://localhost:5173") // 로그아웃 후 프론트엔드 페이지로 리다이렉트
