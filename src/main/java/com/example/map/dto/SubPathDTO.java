...
public class SubPathDTO {
    ...
    // 버스 | 지하철
    private Integer stationCount; // 이동하여 정차하는 정거장 수
    ...
    private PassStopListDTO passStopList; // 경로 상세구간 역/정류장 정보 리스트
    ...
    // 버스
    private Integer startStationCityCode; // 출발 정류장 도시코드
    private Integer startStationProviderCode; // 출발 정류장 BIS 코드 (BIS 제공지역인 경우에만 필수)
    ...
    private Integer endStationCityCode; // 도착 정류장 도시코드
    private Integer endStationProviderCode; // 도착 정류장 BIS 코드 (BIS 제공지역인 경우에만 필수)
